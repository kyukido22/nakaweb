...
$email->Body = 'testing email service t3 - there will be mulitple versions of this test.';
$email->Body .= 'please reply to all and let me know if you get this. <br>';
$email->Body .= "email->AddAddress('cdgray@roundlakeflyingdragons.com');<br>
	email->AddCC('tcurtis8651@gmail.com');<br>
	email->AddCC('john.cantin@gmail.com');<br>
	email->AddBCC('jcantin@strategicfuse.com');";

$email->AddAddress('cdgray@roundlakeflyingdragons.com');
$email->AddCC('john.cantin@gmail.com');
