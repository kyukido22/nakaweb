...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$o_logit->logit('refresing browswer with GET');
...
$dbconn->fetchIt($theq, null, $rows, true);
...
$thehtml = LoadTheHTML(null, 'page_selectstudent', null, $o_logit, 1, 1);
if ($thehtml == '') {
